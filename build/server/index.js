...
const Header = ({ listing, profileImageData, operatingHoursStatus, ratingsData }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: ` mt-4`, children: /* @__PURE__ */ jsxs("div", { className: `flex gap-2  w-full   md:rounded-xl`, children: [
    /* @__PURE__ */ jsx("div", { className: `bg-white w-[60px] min-w-[60px] md:w-[95px] md:min-w-[95px] h-[60px] md:h-[95px] rounded-lg relative overflow-hidden border-[1px]  border-gray-200`, children: (listing == null ? void 0 : listing.image_url) ? /* @__PURE__ */ jsx(
      "img",
      {
        src: profileImg,
        alt: "",
